 ...
 * @version 1.0.0
 *
 * API for transcription, translation, question generation, and answer verification
 */
export class Api<
...
> extends HttpClient<SecurityDataType> {
  transcript = {
    ...
    transcriptList: (
      query: {
        /** URL of the content to transcribe */
        url: string;
      },
  ...
  buildQuestions = {
     ...
     *
     * @name BuildQuestionsCreate
     * @summary Generate Questions
     * @request POST:/build_questions
     */
    buildQuestionsCreate: (
      query: {
  ...
  checkAnswer = {
     ...
     *
     * @name CheckAnswerCreate
     * @summary Check Answer
     * @request POST:/check_answer
     */
    checkAnswerCreate: (
      data: {
        /** The question text */
